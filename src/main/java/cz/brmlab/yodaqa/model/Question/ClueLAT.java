 ...
 * @generated */
public class ClueLAT extends Clue {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ClueLAT.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ClueLAT() {/* intentionally empty block */}
   ...
   */
  public ClueLAT(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ClueLAT(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
