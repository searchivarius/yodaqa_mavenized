 ...
 * @generated */
public class ClueNgram extends Clue {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ClueNgram.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ClueNgram() {/* intentionally empty block */}
   ...
   */
  public ClueNgram(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ClueNgram(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
