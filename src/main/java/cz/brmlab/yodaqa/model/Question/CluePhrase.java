 ...
 * @generated */
public class CluePhrase extends Clue {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(CluePhrase.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected CluePhrase() {/* intentionally empty block */}
   ...
   */
  public CluePhrase(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public CluePhrase(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
