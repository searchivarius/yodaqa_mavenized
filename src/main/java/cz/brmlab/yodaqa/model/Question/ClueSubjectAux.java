 ...
 * @generated */
public class ClueSubjectAux extends Clue {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ClueSubjectAux.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ClueSubjectAux() {/* intentionally empty block */}
   ...
   */
  public ClueSubjectAux(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ClueSubjectAux(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ClueSubjectAux(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
