 ...
 * @generated */
public class ClueSubjectNE extends ClueSubject {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ClueSubjectNE.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ClueSubjectNE() {/* intentionally empty block */}
   ...
   */
  public ClueSubjectNE(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ClueSubjectNE(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ClueSubjectNE(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
