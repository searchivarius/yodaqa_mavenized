 ...
 * @generated */
public class ClueSubjectPhrase extends ClueSubject {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ClueSubjectPhrase.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ClueSubjectPhrase() {/* intentionally empty block */}
   ...
   */
  public ClueSubjectPhrase(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ClueSubjectPhrase(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ClueSubjectPhrase(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
