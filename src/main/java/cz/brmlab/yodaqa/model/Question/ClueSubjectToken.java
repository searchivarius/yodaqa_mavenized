 ...
 * @generated */
public class ClueSubjectToken extends ClueSubject {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ClueSubjectToken.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ClueSubjectToken() {/* intentionally empty block */}
   ...
   */
  public ClueSubjectToken(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ClueSubjectToken(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ClueSubjectToken(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
