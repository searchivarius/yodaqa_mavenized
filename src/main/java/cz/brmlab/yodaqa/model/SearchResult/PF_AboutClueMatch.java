 ...
 * @generated */
public class PF_AboutClueMatch extends PassageFeature {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(PF_AboutClueMatch.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected PF_AboutClueMatch() {/* intentionally empty block */}
   ...
   */
  public PF_AboutClueMatch(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public PF_AboutClueMatch(JCas jcas) {
    super(jcas);
    readObject();   
  } 
