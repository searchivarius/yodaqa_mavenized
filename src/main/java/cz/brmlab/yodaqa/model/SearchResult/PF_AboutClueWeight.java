 ...
 * @generated */
public class PF_AboutClueWeight extends PassageFeature {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(PF_AboutClueWeight.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected PF_AboutClueWeight() {/* intentionally empty block */}
   ...
   */
  public PF_AboutClueWeight(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public PF_AboutClueWeight(JCas jcas) {
    super(jcas);
    readObject();   
  } 
