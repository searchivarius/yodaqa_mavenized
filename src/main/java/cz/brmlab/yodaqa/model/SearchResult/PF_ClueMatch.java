 ...
 * @generated */
public class PF_ClueMatch extends PassageFeature {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(PF_ClueMatch.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected PF_ClueMatch() {/* intentionally empty block */}
   ...
   */
  public PF_ClueMatch(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
