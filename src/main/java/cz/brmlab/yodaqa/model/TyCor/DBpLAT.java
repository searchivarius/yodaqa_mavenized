 ...
 * @generated */
public class DBpLAT extends LAT {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(DBpLAT.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected DBpLAT() {/* intentionally empty block */}
   ...
   */
  public DBpLAT(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public DBpLAT(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
