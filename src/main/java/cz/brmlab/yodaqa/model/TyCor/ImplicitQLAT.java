 ...
 * @generated */
public class ImplicitQLAT extends LAT {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ImplicitQLAT.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ImplicitQLAT() {/* intentionally empty block */}
   ...
   */
  public ImplicitQLAT(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ImplicitQLAT(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
