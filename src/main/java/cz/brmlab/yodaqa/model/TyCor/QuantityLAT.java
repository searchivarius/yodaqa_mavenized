 ...
 * @generated */
public class QuantityLAT extends LAT {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(QuantityLAT.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected QuantityLAT() {/* intentionally empty block */}
   ...
   */
  public QuantityLAT(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public QuantityLAT(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
