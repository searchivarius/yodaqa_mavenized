 ...
 * @generated */
public class WordnetLAT extends LAT {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(WordnetLAT.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected WordnetLAT() {/* intentionally empty block */}
   ...
   */
  public WordnetLAT(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public WordnetLAT(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
